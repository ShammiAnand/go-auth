...
func (urd *UserRolesDelete) Where(ps ...predicate.UserRoles) *UserRolesDelete {
	urd.mutation.Where(ps...)
	return urd
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (urd *UserRolesDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, urd.sqlExec, urd.mutation, urd.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (urd *UserRolesDelete) ExecX(ctx context.Context) int {
	n, err := urd.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (urd *UserRolesDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(userroles.Table, sqlgraph.NewFieldSpec(userroles.FieldID, field.TypeUUID))
...
// Where appends a list predicates to the UserRolesDelete builder.
func (urdo *UserRolesDeleteOne) Where(ps ...predicate.UserRoles) *UserRolesDeleteOne {
	urdo.urd.mutation.Where(ps...)
	return urdo
}

// Exec executes the deletion query.
func (urdo *UserRolesDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (urdo *UserRolesDeleteOne) ExecX(ctx context.Context) {
