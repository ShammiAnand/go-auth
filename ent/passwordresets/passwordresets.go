...
const (
	// Label holds the string label denoting the passwordresets type in the database.
	...
	// Table holds the table name of the passwordresets in the database.
	Table = "password_resets"
)

// Columns holds all SQL columns for passwordresets fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldEmail,
...
// OrderOption defines the ordering options for the PasswordResets queries.
